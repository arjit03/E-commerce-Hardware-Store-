  ...
  <div class="grid" style="flex-direction:column">
    ...
    <div class="grey-text text-lighten-4">
      <p style="margin:0px 150px 0px 150px;font-size:25px;text-align:justify">
        OG Tech was a Company that selling Computer Component which found by university student Arjit Sasan and started its business at Roorkee on 1th January 2024.
