          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>INR$displayShipping</span>";
                else $displayShipping = "INR$displayShipping";

                if ($sumTotal >= 2000){
                  $shippingTotal = $sumTotal - 100;
                  $displayPVoucher = "<span class='underline'>-INR100</span> <span class='yellow-text'>(Promo voucher applied)</span>";
                }
                ...
                echo("<tr><th>Sum Total:</th><td>INR$sumTotal</td></tr>");
